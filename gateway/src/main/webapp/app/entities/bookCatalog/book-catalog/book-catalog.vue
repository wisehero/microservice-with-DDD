  ...
  <div>
    <h2 id="page-heading" data-cy="BookCatalogHeading">
      ...
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          ...
          <span v-text="$t('gatewayApp.bookCatalogBookCatalog.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'BookCatalogCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('gatewayApp.bookCatalogBookCatalog.home.createLabel')"> Create a new Book Catalog </span>
          </button>
        </router-link>
      </div>
    </h2>
          ...
          <tr v-for="bookCatalog in bookCatalogs" :key="bookCatalog.id" data-cy="entityTable">
            ...
            <td class="text-right">
              <div class="btn-group">
                ...
                <b-button
                  v-on:click="prepareRemove(bookCatalog)"
                  variant="danger"
                  class="btn btn-sm"
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span
          id="gatewayApp.bookCatalogBookCatalog.delete.question"
          data-cy="bookCatalogDeleteDialogHeading"
          v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-bookCatalog-heading" v-text="$t('gatewayApp.bookCatalogBookCatalog.delete.question', { id: removeId })">
          Are you sure you want to delete this Book Catalog?
        </p>
      </div>
