...
import BookComponent from '@/entities/book/book/book.vue';
import BookClass from '@/entities/book/book/book.component';
...
describe('Component Tests', () => {
  describe('Book Management Component', () => {
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(bookServiceStub.retrieve.callCount).toEqual(3);
