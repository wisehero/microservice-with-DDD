...
import RentalComponent from '@/entities/rental/rental/rental.vue';
import RentalClass from '@/entities/rental/rental/rental.component';
...
describe('Component Tests', () => {
  describe('Rental Management Component', () => {
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(rentalServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(rentalServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});
