...
/**
 * REST controller for managing {@link com.my.rental.domain.RentedItem}.
 */
@RestController
@RequestMapping("/api")
public class RentedItemResource {
    ...
    public ResponseEntity<List<RentedItemDTO>> getAllRentedItems(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
